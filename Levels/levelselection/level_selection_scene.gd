...
onready var ai = $CanvasLayer/npc_ai
...
func _ready():
	...
	if NpcTalkingGlobal.will_talk:
		var talk_index = NpcTalkingGlobal.dialogue_number
		ai.talking_array(NpcTalkingGlobal.ai_talking_lines[talk_index],NpcTalkingGlobal.ai_talking_emotions[talk_index])
