...
func update_equation_string():
	get_parent().stored_value = equation_string

func set_equation_string(eq_string : String):
	equation_string = eq_string
	_on_equation_question_created()
